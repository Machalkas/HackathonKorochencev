...
class Teams(models.Model):
    ...
    link=models.CharField(max_length=100, blank=True, default="", verbose_name="Социальные ссылки")
    url=models.CharField(max_length=100,blank=True, default="", unique=True, verbose_name="Ссылка для вступления в команду")
